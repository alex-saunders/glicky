...
/**
 * ServerHandler implements Server and provides abstractions above
 * whatever technology we are using to communicate with the server,
 * helping to make other util classes/functons that communicate with
 * the server be non-implementation-specific
 */
interface Server {
